...
@section('header')
    <section class="header-operation container-fluid animated fadeIn d-flex my-2 align-items-baseline d-print-none"
        bp-section="page-header">
        {{-- <h1 class="text-capitalize mb-0" bp-section="page-heading">{!! $crud->getHeading() ?? $crud->entity_name_plural !!}</h1> --}}
        <p class="ms-2 ml-2 mb-0 d-grid" id="datatable_info_stack" bp-section="page-subheading">{!! $crud->getSubheading() ?? '' !!}</p>
    </section>
@endsection
                ...
                <table id="crudTable"
                    ...
                    <thead>
                        <tr class="text-end">
                            ...
                            {{-- Start of the foreach loop to go through each column --}}
                            @foreach ($crud->columns() as $column)
                                ...
                                {{-- Column header cell --}}
                                <th data-orderable="{{ var_export($column['orderable'], true) }}" class="text-end"
                                    ...
                                    {{-- Bulk checkbox if it’s the first column --}}
                                ...
                                {{-- End of the foreach loop for each column --}}
                            @endforeach

                            {{-- Actions column if there are line buttons --}}
                            @if ($crud->buttons()->where('stack', 'line')->count())
                                <th class="text-end" data-orderable="false"
